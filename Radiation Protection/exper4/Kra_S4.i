...
C Shield: Paraffin + Krafton-HB4 layer*4
C Tally: F4
C ------------------------------------------------------ C
C Author   Zihao Xu              
C Date     2021-5-27
...
C -----cells-----
 ...
 3   4      -1.58    23 -24 8 -9 12 -13        
 4   4      -1.58    25 -26 8 -9 12 -13        
 5   4      -1.58    27 -28 8 -9 12 -13        $shielder_4
 6   1  -0.001205    14 -15 -16                $detector
31   1  -0.001205    -70 #1 #2 #3 #4 #5 #6     $air surface
50   0               70                        $vaccum
